        ...
        <Reveal>
          <div className="max-w-3xl">
            ...
            <h2 className="mt-6 font-display text-5xl font-bold leading-[0.95] tracking-tight md:text-7xl">
              Lo que hacemos,
              <br />
              <span className="text-gradient-primary animate-gradient-x font-light italic">lo hacemos bien.</span>
            </h2>
          ...
          {services.map((s, i) => (
            <Reveal key={s.title} delay={i * 90}>
              <TiltCard className="h-full">
                <div className="shine relative h-full overflow-hidden rounded-3xl glass p-8 transition-shadow duration-500 hover:shadow-glow-sm">
