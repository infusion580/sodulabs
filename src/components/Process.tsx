      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <Reveal>
          <div className="mb-16 max-w-3xl">
            ...
            <h2 className="mt-6 font-display text-5xl font-bold leading-[0.95] tracking-tight md:text-7xl">
              Cómo
              <br />
              <span className="text-gradient-primary animate-gradient-x font-light italic">trabajamos.</span>
            </h2>
        ...
        <div className="relative">
          ...
          <ol className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {steps.map((s, i) => (
              <Reveal as="div" key={s.n} delay={i * 100}>
                <TiltCard className="h-full" max={6}>
                  <li className="shine relative h-full overflow-hidden rounded-3xl glass p-8 transition-shadow duration-500 hover:shadow-glow-sm">
